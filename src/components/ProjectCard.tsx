    ...
    >
      <div
        ...
        onMouseEnter={(e) => {
          ...
          el.style.boxShadow =
            '0 16px 64px rgba(79,142,247,0.25), inset 0 1px 0 rgba(255,255,255,0.15)'
      ...
      >
        {/* =====================================================
            BROWSER MOCKUP
        ====================================================== */}
        <div className="flex flex-col min-h-0 flex-[2_1_0%]">
          {/* Browser toolbar */}
          <div
            className="
              flex
          ...
          {/* =================================================
              SCREENSHOT
              IMPORTANT: object-contain prevents top cropping
          ================================================== */}
          <div
            className="
              relative
            ...
            {project.tags.map((tag) => (
              <span
                ...
                className="
                  ...
                  transition-all
                  duration-300
                  group-hover:shadow-[0_0_12px_rgba(79,142,247,0.25)]
